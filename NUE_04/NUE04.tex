...
\begin{quote}
    ...
    \begin{quote}
        ...
        \TODO{hier könnten wir die ganze Herleitung auch wegkicken, es steht
        eins zu eins auch schon in der Theorie}
    ...
    \TODO{der Satz ist nicht vollständig}
    ...
    \TODO{wollen wir als Zeichen unseres Fleißes die zusätzliche Arbeit drin
    lassen?}
    \begin{quote}
...
%--------------------------------------------------------------------    
    ...
    \TODO{Frequenzbereich der Sinus shape top abtastung einfügen}
    ...
    \TODO{Freuenzsignal des tp Rechtecks einfügen}
